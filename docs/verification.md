...
- PR #27 implementation head `f9c63349c821164f79a6d74c910730e955823c30`: GitHub Actions run `34980869733` passed `backend`, `frontend`, and `containers`, including Compose and Playwright, while real OSM provider verification remained deliberately separate; and
